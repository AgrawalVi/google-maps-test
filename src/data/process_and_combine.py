...
if __name__ == "__main__":
    ...
    input_folder = '/Users/vishrutagrawal/xorbix/repos/google-maps-test/src/data/raw-zipcodes-by-state/IL'
    # Replace with your desired output file path
    output_file = '/Users/vishrutagrawal/xorbix/repos/google-maps-test/src/data/parsed-data-by-state/illinois_data.json'
